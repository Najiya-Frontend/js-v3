...
var Player = {
    ...
    init: function () {
        try {
            ...
            stbPlayer.setBufferSize(6000, 2500000);
    ...
    mirrorScreen: function () {
        try {
            stbPlayer.screenMirror();
        } catch (e) {
           console.log("mirrorScreen error :: " + e.message);
        }
    },
    preloadedApplication: function (i) {
        try {
            stbPlayer.openExternalApp(i);
        } catch (e) {
           console.log("preloadedApplication error :: " + e.message);
        }
    },
    ...
    getMacAddress: function () {
        try {
            var mac = gSTB.GetDeviceMacAddress();
            var match = mac.match(/.{1,2}/g);
            return match.join(":");
        } catch (a) {
    ...
    stop: function () {
        // alert("Player.stop :: function :: called");
        try {
            this.currentMrl = "";
    ...
    removeCache: function () {
        try {
            // gSTB.ExecAction("cache_flush");
            gSTB.ExecAction("super_exit");
        } catch (b) {
           console.log("Player.removeCache() error :: " + a.message);
        }
    },
    removePlayerView: function (t) {
        try {
            // alert("Player.removePlayerView :: function :: called");
            stbPlayer.removePlayerView(t);
        } catch (b) {
           console.log("Player.removePlayerView() error :: " + a.message);
        }
    },
